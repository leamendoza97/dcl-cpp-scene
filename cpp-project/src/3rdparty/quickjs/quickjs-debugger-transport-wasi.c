...
{
    struct js_debugger_target js_transport_data = js_debugger_parse_debugger_target(address);
    js_debugger_attach(ctx, js_transport_read, js_transport_write, js_transport_peek, js_transport_close, &js_transport_data);
}
